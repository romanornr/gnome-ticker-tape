...
- `services/providers/hyperliquid-live.js`: Hyperliquid perpetual-futures provider with REST snapshot fallback and websocket protocol handling
...
- `utils/crypto-providers/kraken/symbols.js`: Kraken live-symbol normalization and saved ticker id derivation
- `utils/crypto-providers/hyperliquid/catalog.js`: Hyperliquid perpetual-market discovery, snapshot loading, and catalog entry normalization
...
- `utils/crypto-providers/hyperliquid/symbols.js`: Hyperliquid perpetual-market symbol normalization
